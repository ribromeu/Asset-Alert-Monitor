...
<!-- ============================================================ -->
<!-- INSERT EMAIL SCREENSHOT HERE                                  -->
<!-- After running a dry run (Actions → Asset Alert Monitor →     -->
<!-- Run workflow → Dry run: true), download the artifact          -->
<!-- "email-preview" and take a screenshot of alert_preview.html  -->
<!-- Then upload the image to this repo and replace the line below -->
<!-- ============================================================ -->

> 📸 *Email screenshot coming soon — run a dry run to preview locally.*
